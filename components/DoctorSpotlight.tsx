      ...
      <div className="max-w-6xl mx-auto px-5 md:px-8 pb-20 md:pb-28 pt-2 md:pt-4">
        {doctor ? (
          ...
          <div className="max-w-xl">
            ...
            <h2 className="font-display text-3xl md:text-4xl">
              A familiar face, {clinic.yearsActive} years running.
            </h2>
            <p className="mt-6 text-porcelain/75 leading-relaxed max-w-xl">
              Full profile coming soon. In the meantime, call or WhatsApp{" "}
              {clinic.phone} and the team will be happy to introduce you.
            </p>
          </div>
        )}
      </div>
